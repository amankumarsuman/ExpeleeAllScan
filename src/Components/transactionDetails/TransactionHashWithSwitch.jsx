...
import { formatTransactionDetails, getTransactionDetails } from "./Transaction-utils";
import TransactionDetailsUI from "./TransactionDetailsUI";

function TransactionDetailsTest({details,error}) {
  ...
  //   setError(null);
  //   try {
  //     const TransactionResult = await getTransactionDetails(transactionHash, network);
